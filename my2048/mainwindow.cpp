    ...
    , ui(new Ui::MainWindow)
{
    ...
    button = new QPushButton("开始游戏", this);//开始游戏界面
    button -> setGeometry(60,400,200,50);//生成按钮
...
void MainWindow::slotStart()
{
    ...
    int randi = QRandomGenerator::global() -> bounded(4);
    int randj = QRandomGenerator::global() -> bounded(4);
    s[randi][randj] = 2;
    state = true;
    update();
...
void MainWindow::myRand()
{
    ...
    if(ni == 0)
    {
        ...
        QMessageBox::about(this,"游戏结束","分数："+QString::number(score)+"");
        return;
    }
